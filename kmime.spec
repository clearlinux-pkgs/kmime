...
Source0  : https://github.com/KDE/kmime/archive/v18.08.3.tar.gz
...
%package abi
Summary: abi components for the kmime package.
Group: Default

%description abi
abi components for the kmime package.
...
export LANG=C
export SOURCE_DATE_EPOCH=1541691691
mkdir -p clr-build
pushd clr-build
%cmake ..
...
%files abi
%defattr(-,root,root,-)
/usr/share/abi/libKF5Mime.so.5.9.3.abi
/usr/share/abi/libKF5Mime.so.5.abi
