...
Version  : 18.12.0
Release  : 12
URL      : https://github.com/KDE/kmime/archive/v18.12.0.tar.gz
Source0  : https://github.com/KDE/kmime/archive/v18.12.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1544886165
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKF5Mime.so.5.10.0
