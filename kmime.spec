...
Version  : 24.02.2
Release  : 84
URL      : https://download.kde.org/stable/release-service/24.02.2/src/kmime-24.02.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/kmime-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/kmime-24.02.2.tar.xz.sig
...
%prep
%setup -q -n kmime-24.02.2
cd %{_builddir}/kmime-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712860563
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6Mime.so.6.0.2
/usr/lib64/libKPim6Mime.so.6
/usr/lib64/libKPim6Mime.so.6.0.2
...
%files locales -f libkmime6.lang
%defattr(-,root,root,-)
