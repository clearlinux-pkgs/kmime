...
Source0  : https://download.kde.org/stable/release-service/21.04.0/src/kmime-21.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.04.0/src/kmime-21.04.0.tar.xz.sig
...
%prep
%setup -q -n kmime-21.04.0
cd %{_builddir}/kmime-21.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619155574
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmime-21.04.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kmime/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/kmime-21.04.0/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kmime/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kmime-21.04.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kmime/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
%find_lang libkmime5
...
/usr/lib64/libKF5Mime.so.5.17.0
