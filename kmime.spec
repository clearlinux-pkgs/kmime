...
Source0  : https://download.kde.org/stable/release-service/22.04.2/src/kmime-22.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.2/src/kmime-22.04.2.tar.xz.sig
...
%prep
%setup -q -n kmime-22.04.2
cd %{_builddir}/kmime-22.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654834201
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmime-22.04.2/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/kmime/c085897bc39e05746ffd2d889a6e84ff1b7ae2d9
cp %{_builddir}/kmime-22.04.2/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/kmime/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/kmime-22.04.2/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kmime/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/kmime-22.04.2/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kmime/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kmime-22.04.2/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kmime/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kmime-22.04.2/README.md.license %{buildroot}/usr/share/package-licenses/kmime/cadc9e08cb956c041f87922de84b9206d9bbffb2
cp %{_builddir}/kmime-22.04.2/metainfo.yaml.license %{buildroot}/usr/share/package-licenses/kmime/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4
pushd clr-build
%make_install
popd
%find_lang libkmime5
...
/usr/lib64/libKF5Mime.so.5.20.2
