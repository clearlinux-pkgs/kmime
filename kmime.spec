...
Source0  : https://download.kde.org/stable/release-service/20.12.0/src/kmime-20.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.0/src/kmime-20.12.0.tar.xz.sig
...
%prep
%setup -q -n kmime-20.12.0
cd %{_builddir}/kmime-20.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607720323
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmime-20.12.0/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kmime/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kmime-20.12.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kmime/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
%find_lang libkmime5
...
/usr/lib64/libKF5Mime.so.5.16.0
