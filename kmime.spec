...
Version  : 18.11.80
Release  : 10
URL      : https://github.com/KDE/kmime/archive/v18.11.80.tar.gz
Source0  : https://github.com/KDE/kmime/archive/v18.11.80.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1542514512
mkdir -p clr-build
pushd clr-build
%cmake ..
...
/usr/lib64/libKF5Mime.so.5.9.80
