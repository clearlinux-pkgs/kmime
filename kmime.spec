...
Source0  : https://download.kde.org/stable/release-service/24.05.2/src/kmime-24.05.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.2/src/kmime-24.05.2.tar.xz.sig
...
%setup -q -n kmime-24.05.2
cd %{_builddir}/kmime-24.05.2
pushd ..
cp -a kmime-24.05.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720541349
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6Mime.so.6.1.2
/usr/lib64/libKPim6Mime.so.6
/usr/lib64/libKPim6Mime.so.6.1.2
