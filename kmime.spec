...
Version  : 22.12.3
Release  : 62
URL      : https://download.kde.org/stable/release-service/22.12.3/src/kmime-22.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/kmime-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/kmime-22.12.3.tar.xz.sig
...
%prep
%setup -q -n kmime-22.12.3
cd %{_builddir}/kmime-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677787709
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Mime.so.5.22.3
