...
Version  : 18.12.1
Release  : 13
URL      : https://github.com/KDE/kmime/archive/v18.12.1.tar.gz
Source0  : https://github.com/KDE/kmime/archive/v18.12.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1547132218
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKF5Mime.so.5.10.1
