...
Version  : 18.04.3
Release  : 2
URL      : https://github.com/KDE/kmime/archive/v18.04.3.tar.gz
Source0  : https://github.com/KDE/kmime/archive/v18.04.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1532544582
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
